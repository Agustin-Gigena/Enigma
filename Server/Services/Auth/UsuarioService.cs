...
public interface IUsuarioService
{
    ...
    /// </summary>
    Task<LoginResultado?> LoginAsync(string nombreUsuario, string contrasena);

    Task<Usuario?> ObtenerPorNombreAsync(string nombreUsuario);

    Task<List<Institucion>> ObtenerInstitucionesAsync(int usuarioId);
}
...
public class UsuarioService : IUsuarioService
{
    ...
    public async Task<LoginResultado?> LoginAsync(string nombreUsuario, string contrasena)
    {
        ...
        var instituciones = await _usuarioRepository.ObtenerInstitucionesAsync(usuario.Id);
